...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (action === "create_employee") {
      const { email, password, full_name, permissions, job_title, job_code, motto, description, country } = body;
      ...
      // Save employee details (job title, code, motto, description, country)
